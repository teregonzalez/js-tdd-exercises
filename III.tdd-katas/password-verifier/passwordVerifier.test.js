...
describe('Verify function', () => {
    ...
    it('Giving "123456et" should throw an error', () => {
        //Arrange
        const password = '123456et';
        ...
        //Assert
        expect(result).toThrow('Password must contain an uppercase letter');
    });
    it('Giving "Passwordd" should throw an error', () => {
        //Arrange
        ...
        //Assert
        expect(result).toThrow('Password must contain a number');
    });
});